...
// 所有 ResultEntry，ResultEntry 包含 template 的計數結果
...
// 計算整體的覆蓋率，不直接呼叫，由 coverageReporter.ComputeSummary() 調用
...
// 產生整體覆蓋率結果。不直接呼叫，由 coverageReporter.Generate() 調用
...
// 產生百分比，不直接調用，由 RenderTable() 輸出報表時調用
